 ...
 */
/**
 * הערכת ק"מ/ליטר גנרית לפי סוג דלק - משמשת רק כשנבחר דגם ספציפי שאין
 * לו נתון WLTP רשמי במאגר (כ-28% מהדגמים הלא-חשמליים חסרי נתון צריכה).
 */
export const FUEL_KM_PER_LITER_ESTIMATE: Partial<Record<import("./types").FuelType, number>> = {
  gasoline: 13,
  diesel: 16,
  hybrid: 20,
};
